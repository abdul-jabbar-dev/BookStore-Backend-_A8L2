...
exports.DeleteCategory = exports.UpdateCategory = exports.GetACategory = exports.GetCategory = exports.CreateCategory = void 0;
...
exports.CreateCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (0, category_service_1.CreateCategoryDB)(title);
...
exports.GetACategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield (0, category_service_1.GetACategoryDB)(id);
    (0, sendResponse_1.default)(res, {
        data: result,
        success: true,
        statusCode: 200,
...
exports.UpdateCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (0, category_service_1.UpdateCategoryDB)(id, updatedData);
    (0, sendResponse_1.default)(res, {
        data: result,
        success: true,
        statusCode: 200,
...
exports.DeleteCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield (0, category_service_1.DeleteCategoryDB)(id);
    (0, sendResponse_1.default)(res, {
        data: result,
        success: true,
        statusCode: 200,
